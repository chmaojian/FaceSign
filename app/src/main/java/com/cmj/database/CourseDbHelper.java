...
import com.cmj.tools.FileTools;
...
public class CourseDbHelper extends SQLiteOpenHelper {
    public static final String DATABASE_NAME = FileTools.getSDPath() + "/faceRecognize/Data/sign.db";
    String SQL_CREATE_COURSE = "create table " + SignTable.TableName +
    ...
    public boolean isTableEmpty() {
        ...
        String sql = "SELECT * FROM " + SignTable.TableName;
